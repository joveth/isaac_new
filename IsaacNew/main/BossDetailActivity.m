...
- (void)viewDidLoad {
    ...
    [menuBtn setImage:[UIImage imageNamed:@"more2"] forState:UIControlStateNormal];
    ...
    UITableView *tab = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, screenWidth, height-40)];
    ...
    [self setMinimumWidth:screenWidth-60 maximumWidth:screenWidth forViewController:self.leftTab];
...
- (void)startPresentationMode
{
    ...
    {
        [self enterPresentationModeForViewController:PKRevealControllerShowsRightViewController
                                            animated:YES
                                          completion:nil ];
    }
    else
